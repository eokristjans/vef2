INSERT INTO application (nafn, netfang, simi, kynning, starf, processed) VALUES 
  ( 'Jón Jónsson'
  , 'jon@example.org'
  , 1231231
  , 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut bibendum eleifend odio, eu laoreet sapien sollicitudin quis.'
  , 'forritari'
  , False);
INSERT INTO application (nafn, netfang, simi, kynning, starf, processed) VALUES 
...
INSERT INTO application (nafn, netfang, simi, kynning, starf, processed) VALUES 
  ...
  , 'anna@example.org'
  , 3333333
  , 'Sed in sem sagittis, fringilla justo eget, vulputate nunc. Cras pharetra faucibus blandit. Sed non porta ligula, non efficitur dolor.'
  , 'forritari'
  , False);
INSERT INTO application (nafn, netfang, simi, kynning, starf, processed) VALUES 
